...
// TODO нужно добавить при создании/редактировании задачи поле email
//а фронте даня в списке показываем визуально список имейлов, но при клике подставляет айди пользователя

// то что мы видим визуально не обязательно именно это и отправлять
// делай что если поле заполнено то берешь оттуда юзера (если он существует), а если ауди не передали - то бери ауди того кто прислал запрос
